/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 082858209a87d54f0e6c6c06b151ba8c)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DIRECTOR_ENABLED: string;
	DIRECTOR_GAME_ID: string;
	OPENAI_MODEL: string;
	DIRECTOR_DAILY_REQUEST_LIMIT: string;
	DIRECTOR_ROUND_REQUEST_LIMIT: string;
	DIRECTOR_MAX_OUTPUT_TOKENS: string;
	SENTRY_DSN: string;
	SENTRY_ENVIRONMENT: string;
	SENTRY_RELEASE: string;
	SENTRY_TRACES_SAMPLE_RATE: string;
	ZT_GATEWAY_TOKEN: string;
	ZT_HOST_MAC: string;
	GAME_ROOM: DurableObjectNamespace<import("./src/index").GameRoom>;
	OUTBREAK_DIRECTOR: DurableObjectNamespace<import("./src/index").OutbreakDirector>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRoom" | "OutbreakDirector";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIRECTOR_ENABLED" | "DIRECTOR_GAME_ID" | "OPENAI_MODEL" | "DIRECTOR_DAILY_REQUEST_LIMIT" | "DIRECTOR_ROUND_REQUEST_LIMIT" | "DIRECTOR_MAX_OUTPUT_TOKENS" | "SENTRY_DSN" | "SENTRY_ENVIRONMENT" | "SENTRY_RELEASE" | "SENTRY_TRACES_SAMPLE_RATE" | "ZT_GATEWAY_TOKEN" | "ZT_HOST_MAC">> {}
}
